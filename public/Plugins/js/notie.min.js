        ...
        !(function (c, o) {
          ...
          return (function (e) {
            function t(s) {
              ...
              var a = (n[s] = { i: s, l: !1, exports: {} });
              return (
                e[s].call(a.exports, a, a.exports, t),
                (a.l = !0),
                a.exports
              );
            }
              ...
              var a =
                ...
                g = function (e, t) {
                  ...
                  ((n.id = r.ids.overlay),
                    ...
                    d().then(function () {
                      ((n.style.transition = v()),
                        (n.style.opacity = r.overlayOpacity));
                    }));
                },
                h = function () {
                ...
                E = (t.force = function (e, t) {
                  ...
                  (x.classList.add(r.classes.textbox),
                    x.classList.add(r.classes.backgroundInfo),
                    (x.innerHTML =
                      '<div class="' +
                      r.classes.textboxInner +
                      '">' +
                ...
                T = (t.confirm = function (e, t, n) {
                  ...
                  (E.classList.add(r.classes.textbox),
                    E.classList.add(r.classes.backgroundInfo),
                    (E.innerHTML =
                      '<div class="' +
                      r.classes.textboxInner +
                      '">' +
                ...
                M = function (e, t, n) {
                  ...
                  (H.classList.add(r.classes.textbox),
                    H.classList.add(r.classes.backgroundInfo),
                    (H.innerHTML =
                      '<div class="' +
                      r.classes.textboxInner +
                      '">' +
              ...
              var H = (t.select = function (e, t) {
                  ...
                  (v.classList.add(r.classes.textbox),
                    ...
                    c.forEach(function (e, t) {
                      ...
                      (o.classList.add(m[s]),
                        o.classList.add(r.classes.button),
                        o.classList.add(r.classes.selectChoice));
                      var p = c[t + 1];
                      (p && !p.type && (p.type = 1),
                        p &&
                          p.type === s &&
                          o.classList.add(r.classes.selectChoiceRepeated),
                        (o.innerHTML = a),
                        (o.onclick = function () {
                          (L(u, l), h(), i());
                        }),
                ...
                S = (t.date = function (e, t, n) {
                  ...
                  var C = '&#9662',
                    ...
                    H = function (e) {
                      ((E.innerHTML = r.dateMonths[e.getMonth()]),
                        (T.innerHTML = e.getDate()),
                  ...
                  (Y.classList.add(r.classes.button),
                    Y.classList.add(r.classes.elementThird),
                    Y.classList.add(r.classes.dateSelectorUp),
                    (Y.innerHTML = C));
                  var _ = document.createElement('div');
                  (_.classList.add(r.classes.button),
                    _.classList.add(r.classes.elementThird),
                    _.classList.add(r.classes.dateSelectorUp),
                    (_.innerHTML = C));
                  ...
                  var U = document.createElement('div');
                  (U.classList.add(r.classes.button),
                    U.classList.add(r.classes.elementThird),
                    (U.innerHTML = C));
                  var B = document.createElement('div');
                  (B.classList.add(r.classes.button),
                    B.classList.add(r.classes.elementThird),
                    (B.innerHTML = C));
